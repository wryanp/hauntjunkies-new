	...
	<div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
		...
		<div class="bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-sm rounded-xl border-2 border-haunt-orange/30 p-4 sm:p-6">
			<div class="flex items-center justify-between">
				<div class="min-w-0">
					<p class="text-gray-400 text-xs sm:text-sm font-semibold uppercase mb-1">Total Messages</p>
					<p class="text-2xl sm:text-3xl font-bold text-white">{messages.length}</p>
				</div>
				<svg class="w-10 h-10 sm:w-12 sm:h-12 text-green-400/50 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
