...
<SEO
	title="Haunt Junkies"
	description="Haunted attraction reviews and the home of McCloud Manor"
	url="/"
...
<section class="py-16 mobile-landscape:py-10 relative overflow-hidden">
	<!-- Background Image -->
	<div class="absolute inset-0 bg-cover" style="background-image: url('/hauntedgraveyard-bg.webp'); background-position: center top;"></div>
