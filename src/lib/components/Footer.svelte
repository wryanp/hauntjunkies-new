...
<footer class="relative border-t border-haunt-orange/20 py-12 overflow-hidden">
	<!-- Background Image -->
	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
		<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
			...
			<div>
				<a href="/" class="inline-block">
					<img src="/logo-transback.PNG" alt="Haunt Junkies" class="h-12 sm:h-16 md:h-20 w-auto drop-shadow-xl mb-4 hover:opacity-80 transition-opacity cursor-pointer" />
				</a>
			...
			<!-- Social -->
			<div>
				<h3 class="text-haunt-orange text-lg sm:text-xl font-bold mb-4">Follow Us</h3>
				<div class="bg-black/40 md:bg-transparent p-3 md:p-0 rounded-lg">
					...
					<!-- Facebook -->
					<a
						href="https://www.facebook.com/Hauntjunkies"
						target="_blank"
						rel="noopener noreferrer"
						class="text-haunt-orange hover:text-orange-400 transition-all transform hover:scale-110"
						aria-label="Follow us on Facebook"
					>
						<svg class="w-6 h-6 sm:w-7 sm:h-7 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24">
					...
					<!-- Instagram -->
					<a
						href="https://www.instagram.com/hauntjunkies/?hl=en"
						target="_blank"
						rel="noopener noreferrer"
						class="text-haunt-orange hover:text-orange-400 transition-all transform hover:scale-110"
					...
					<!-- TikTok -->
					<a
						href="https://www.tiktok.com/@hauntjunkies"
						target="_blank"
						rel="noopener noreferrer"
						class="text-haunt-orange hover:text-orange-400 transition-all transform hover:scale-110"
		...
		<div class="mt-8 pt-8 border-t border-gray-800 text-center text-gray-500 text-sm sm:text-base">
			<p>&copy; {currentYear} Haunt Junkies. All rights reserved.</p>
		</div>
	</div>
</footer>
