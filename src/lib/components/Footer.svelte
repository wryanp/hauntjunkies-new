		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
			...
			<div>
				...
				<ul class="space-y-2 bg-black/40 md:bg-transparent p-3 md:p-0 rounded-lg inline-block md:block text-sm sm:text-base">
					...
					<li><a href="/about" class="text-gray-400 hover:text-haunt-orange transition-colors">About Us</a></li>
					<li><a href="/contact" class="text-gray-400 hover:text-haunt-orange transition-colors">Contact</a></li>
					{#if isAuthenticated}
						<li><a href="/mccloudmanor" class="text-gray-400 hover:text-haunt-orange transition-colors">McCloud Manor</a></li>
