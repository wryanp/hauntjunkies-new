...
{:else if posts.length === 0}
	<div class="flex items-center justify-center min-h-[260px] md:min-h-[400px] p-8">
		<div class="text-center">
			<svg class="w-16 h-16 mx-auto mb-4 text-haunt-orange opacity-50" fill="currentColor" viewBox="0 0 24 24">
			...
			<p class="text-gray-400 text-lg mb-2">Instagram feed coming soon!</p>
			<p class="text-sm text-gray-500">Follow us on Instagram <a href="https://www.instagram.com/hauntjunkies" target="_blank" rel="noopener noreferrer" class="text-haunt-orange hover:underline">@hauntjunkies</a></p>
		</div>
	</div>
{:else}
